...
export const wizardSlice: any = createSlice({
  ...
  initialState: {
    ...
    workflowId: workflowId || process.env.DEFAULT_WORKFLOW_ID,
    workflow: {},
    journal: {},
    user: {},
    screeningDetails: [],
...
export const { loadStep, prevStep, nextStep, formValidator, handleIsVerified, setFormStep } = wizardSlice.actions;
